...
<html>
    <head>
        ...
        <?php echo $this->Html->css('/Admin/css/bootstrap-wysihtml5'); ?>
        ...
        <?php echo $this->Html->script('/Admin/js/wysihtml5-0.3.0'); ?>
        <script src="//ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
        <?php echo $this->Html->script('/Admin/js/bootstrap.min'); ?>
        <?php echo $this->Html->script('/Admin/js/bootstrap-wysihtml5'); ?>
